...
public class MenuGUI implements CommandExecutor {
    ...
    public MenuGUI(MainPlugin mainPlugin) {
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if(cmd.getName().equalsIgnoreCase("menu")) {
            ...
            ArrayList<String> lore_upgrade = new ArrayList<String>();
            ...
            ArrayList<String> lore_rebirth = new ArrayList<String>();
            ...
            ArrayList<String> lore_locations = new ArrayList<String>();
