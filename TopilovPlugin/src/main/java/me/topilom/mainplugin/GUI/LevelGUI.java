...
public class LevelGUI implements CommandExecutor {
    ...
    public LevelGUI(MainPlugin main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(cmd.getName().equalsIgnoreCase("level")) {
            ...
            //int artefacts = (int) data.getArtefacts(player.getUniqueId());

            if(args.length == 0) {

                Inventory levelup = Bukkit.getServer().createInventory(null, 9, "Повышение уровня");
                ...
                if(level == 1) {
                    ...
                    /*if(artefacts > 500) {
                        ...
                        lore.add(" §fАртефакты: §c§l✖ §c" + artefacts + "§a/500");
                    }*/
                ...
                if(level == 6) {
                player.sendTitle(ChatColor.RED + "У вас максимальный уровень!",ChatColor.GRAY + "Используйте /rebirth чтобы переродиться");
                return true;
                }
