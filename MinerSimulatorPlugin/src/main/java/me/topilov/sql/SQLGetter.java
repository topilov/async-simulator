...
public class SQLGetter {
    ...
    public void createTableBoosters() {
        PreparedStatement ps;
        try {
            ps = App.getInstance().SQL.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS boosters "
    ...
    public void createBoosters(Server server) {
        try {
            ...
            if (!existsBooster(serverID)) {
                PreparedStatement ps3 = App.getInstance().SQL.getConnection().prepareStatement("INSERT IGNORE INTO boosters"
                        + " (uuid) VALUES (?)");
    ...
    public boolean existsBooster(String server){
        try {
            PreparedStatement ps4 = App.getInstance().SQL.getConnection().prepareStatement("SELECT * FROM boosters WHERE uuid=?");
    ...
    public void createTableLocalBoosters() {
        PreparedStatement ps;
        try {
            ps = App.getInstance().SQL.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS localboosters "
    ...
    public void createLocalBoosters(Player player) {
        try {
            ...
            if (!existsLocalBoosters(uuid)) {
                PreparedStatement ps2 = App.getInstance().SQL.getConnection().prepareStatement("INSERT IGNORE INTO localboosters"
                        + " (name,uuid) VALUES (?,?)");
                ps2.setString(1, player.getName());
                ps2.setString(2, uuid.toString());
                ps2.executeUpdate();
    ...
    public boolean existsLocalBoosters(UUID uuid){
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT * FROM localboosters WHERE uuid=?");
            ps.setString(1, uuid.toString());
    ...
    public void addBits(UUID uuid, int bits) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET bits=? WHERE uuid=?");
    ...
    public int getBits(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT bits FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addRebirth(UUID uuid, int rebirth) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET rebirth=? WHERE uuid=?");
    ...
    public int getRebirth(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT rebirth FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addExp(UUID uuid, int exp) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET exp=? WHERE uuid=?");
    ...
    public int getExp(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT exp FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addArtefacts(UUID uuid, int artefacts) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET artefacts=? WHERE uuid=?");
    ...
    public int getArtefacts(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT artefacts FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBackPack(UUID uuid, int backpack) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET backpack=? WHERE uuid=?");
    ...
    public int getBackPack(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT backpack FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBlocksBP(UUID uuid, int blocksBP) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET blocksBP=? WHERE uuid=?");
    ...
    public int getBlocksBP(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT blocksBP FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBoosterBlocks(UUID uuid, int boosterBlocks) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET boosterBlocks=? WHERE uuid=?");
    ...
    public int getBoosterBlocks(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBlocks FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBoosterEXP(UUID uuid, int boosterEXP) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET boosterEXP=? WHERE uuid=?");
    ...
    public int getBoosterEXP(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterEXP FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBoosterBalance(UUID uuid, int boosterBalance) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET boosterBalance=? WHERE uuid=?");
    ...
    public int getBoosterBalance(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBalance FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addBoosterArtefacts(UUID uuid, int boosterArtefacts) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE players SET boosterArtefacts=? WHERE uuid=?");
    ...
    public int getBoosterArtefacts(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterArtefacts FROM players WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addGlobalBoosterBalance(String serverID, int boosterBalance) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE boosters SET boosterBalance=? WHERE uuid=?");
    ...
    public int getGlobalBoosterBalance(String serverID) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBalance FROM boosters WHERE uuid=?");
    ...
    public void addGlobalBoosterEXP(String serverID, int boosterEXP) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE boosters SET boosterEXP=? WHERE uuid=?");
    ...
    public int getGlobalBoosterEXP(String serverID) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterEXP FROM boosters WHERE uuid=?");
            ps.setString(1, serverID);
            ResultSet rs = ps.executeQuery();
    ...
    public void addGlobalBoosterBlocks(String serverID, int boosterBlocks) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE boosters SET boosterBlocks=? WHERE uuid=?");
    ...
    public int getGlobalBoosterBlocks(String serverID) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBlocks FROM boosters WHERE uuid=?");
            ps.setString(1, serverID);
            ResultSet rs = ps.executeQuery();
    ...
    public void addGlobalBoosterArtefacts(String serverID, int boosterArtefacts) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE boosters SET boosterArtefacts=? WHERE uuid=?");
    ...
    public int getGlobalBoosterArtefacts(String serverID) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterArtefacts FROM boosters WHERE uuid=?");
            ps.setString(1, serverID);
            ResultSet rs = ps.executeQuery();
    ...
    public void addLocalBoosterBalance(UUID uuid, int boosterBalance) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE localboosters SET boosterBalance=? WHERE uuid=?");
    ...
    public int getLocalBoosterBalance(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBalance FROM localboosters WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addLocalBoosterEXP(UUID uuid, int boosterEXP) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE localboosters SET boosterEXP=? WHERE uuid=?");
    ...
    public int getLocalBoosterEXP(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterEXP FROM localboosters WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addLocalBoosterBlocks(UUID uuid, int boosterBlocks) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE localboosters SET boosterBlocks=? WHERE uuid=?");
    ...
    public int getLocalBoosterBlocks(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterBlocks FROM localboosters WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
    ...
    public void addLocalBoosterArtefacts(UUID uuid, int boosterArtefacts) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("UPDATE localboosters SET boosterArtefacts=? WHERE uuid=?");
    ...
    public int getLocalBoosterArtefacts(UUID uuid) {
        try {
            PreparedStatement ps = App.getInstance().SQL.getConnection().prepareStatement("SELECT boosterArtefacts FROM localboosters WHERE uuid=?");
            ps.setString(1, uuid.toString());
            ResultSet rs = ps.executeQuery();
