...
public class CaseInteractEvent implements Listener {
    ...
    public void onClick(PlayerInteractEvent e) {
        ...
        /*
        Проверка на ключ в главной руке
        */
        if (e.getClickedBlock().getType() == Material.ENDER_CHEST) {
            if (e.getAction() == Action.LEFT_CLICK_AIR) { e.setCancelled(true); }
            if (e.getPlayer().getInventory().getItemInMainHand().getType() == Material.AIR
                    || !e.getPlayer().getInventory().getItemInMainHand().getItemMeta().getDisplayName().contains("Ключ от §6Обычного ящика")
            ...
            Default Case
            */
            if (e.getPlayer().getInventory().getItemInMainHand().getItemMeta().getDisplayName().contains("Ключ от §6Обычного ящика")) {
                openDefaultCase(e, player);
            }
    ...
    void openPetCase(PlayerInteractEvent e, Player player) {
    ...
    void openDefaultCase(PlayerInteractEvent e, Player player) {
        int amount = player.getInventory().getItemInMainHand().getAmount();
